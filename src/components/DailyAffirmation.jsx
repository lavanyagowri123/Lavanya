...
export default function DailyAffirmation({ onClose }) {
  ...
  return (
    <div
      onClick={onClose}
      style={{ position: 'fixed', inset: 0, zIndex: 50, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, background: 'rgba(250,245,239,0.92)', backdropFilter: 'blur(6px)', WebkitBackdropFilter: 'blur(6px)', fontFamily: "Georgia, 'Times New Roman', serif" }}
    >
      <div onClick={e => e.stopPropagation()} style={{ width: '100%', maxWidth: 360, textAlign: 'center' }}>
        ...
        <button
          onClick={onClose}
          style={{ width: '100%', padding: '14px', background: 'none', border: '1px solid rgba(44,31,20,0.2)', borderRadius: 40, fontFamily: "Georgia, 'Times New Roman', serif", fontSize: '0.78rem', letterSpacing: '0.16em', textTransform: 'uppercase', color: 'rgba(44,31,20,0.5)', cursor: 'pointer', WebkitAppearance: 'none' }}
        >
          Open my journal
        </button>
